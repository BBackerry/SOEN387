		...
		<% for(Address a : addressList) { %>
			<div>
				...
				<div class="btn-group">	
				      ...
				      <a class="btn btn-default" href="CheckOut?step=billAddress&shipAddress=<%=a.getId()%>">Ship to this address</a> 
				      <a class="btn btn-default" href="CheckOut?step=editShipAddress&address=<%=a.getId()%>">Edit</a>
				      <a class="btn btn-default" href="CheckOut?step=deleteShipAddress&address=<%=a.getId()%>">Delete </a>
